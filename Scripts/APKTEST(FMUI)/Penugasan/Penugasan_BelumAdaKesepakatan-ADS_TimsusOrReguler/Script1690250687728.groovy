...
Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_ADS/android.Penugasan.Button.List1.Question5'), 
    0)

Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_ADS/android.Penugasan.Button.Question6'), 
    0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_ADS/android.Penugasan.Button.Camera.Question6'), 
    0)

Mobile.delay(1.5, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_ADS/android.Penugasan.Button.Shutter.Question6'), 
    0)

Mobile.delay(1.5, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_ADS/android.Penugasan.Button.Checklist.Question6'), 
    0)

Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_ADS/android.Penugasan.Button.Question7'), 
    0)

Mobile.sendKeys(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_ADS/android.Penugasan.Button.Question7'), 
    '0825072023')
...
Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_ADS/android.Penugasan.Button.Question8'), 
    0)

Mobile.sendKeys(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_ADS/android.Penugasan.Button.Question8'), 
    'AUTOMATE 25072023')
