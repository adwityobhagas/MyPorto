...
Mobile.tap(findTestObject('PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_KunjunganUlang/android.Penugasan.Button.List3.Question5'), 
    0)
...
Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_KunjunganUlang/android.Penugasan.Button.Question6'), 
    0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_KunjunganUlang/android.Penugasan.Button.OK.Question6'), 
    0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_KunjunganUlang/android.Penugasan.Button.Question7'), 
    0)

Mobile.delay(0.5, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_KunjunganUlang/android.Penugasan.Button.Camera.Question7'), 
    0)

Mobile.delay(1.5, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_KunjunganUlang/android.Penugasan.Button.Shutter.Question7'), 
    0)

Mobile.delay(1.5, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_KunjunganUlang/android.Penugasan.Button.Checklist.Question7'), 
    0)

Mobile.delay(1.5, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_KunjunganUlang/android.Penugasan.Button.Question8'), 
    0)

Mobile.sendKeys(findTestObject('PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_KunjunganUlang/android.Penugasan.Button.Question8'), 
    '0825072023')

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_KunjunganUlang/android.Penugasan.Button.Question9'), 
    0)

Mobile.sendKeys(findTestObject('PENUGASAN(TEST)/Hasil_BelumAdaKesepakatan/rencanaLanjutan_KunjunganUlang/android.Penugasan.Button.Question9'), 
