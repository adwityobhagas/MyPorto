...
Mobile.tap(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/android.Penugasan.Button.Question4'), 
    0)

Mobile.tap(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/android.Penugasan.DDL4.List1'), 0)

Mobile.tap(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/android.Penugasan.Button.Question5'), 
    0)

Mobile.tap(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/android.Penugasan.DDL5.List1'), 0)

Mobile.tap(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/android.Penugasan.Button.Question6'), 
    0)

Mobile.tap(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/android.Penugasan.Button.OKDatePicker.Question6'), 
    0)

Mobile.swipe(0, 2113, 0, 1690)

Mobile.tap(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/android.Penugasan.Button.Question7(RegulerAndTimsus)'), 
    0)

Mobile.sendKeys(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/DEL'), '0817042023')

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/android.Penugasan.Button.Question8(RegulerAndTimsus)'), 
    0)

Mobile.sendKeys(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/DEL (1)'), 'AutomateTest 17032023')

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/android.Penugasan.Button.Kirim(RegulerAndTimsus)'), 
    0)

Mobile.tap(findTestObject('Object Repository/androidButtons/FMUI(DEV)/penugasanPage/android.Penugasan.Button.backToMainPage'), 
    0)
